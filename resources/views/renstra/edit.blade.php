...
@section('content')
<div class="container">
    <a href="/renstras" class="btn btn-primary mb-3">Kembali</a>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nama" value="{{ old('nama', $renstra->nama) }}" placeholder="Nama File">
                            @error('nama')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{ asset('storage/' . $renstra->file) }}" target="_blank">{{ $renstra->nama }}</a>
                            </div>
                            @endif
                            @error('file')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" name="tahun" value="{{ old('tahun', $renstra->tahun) }}" placeholder="Tahun" min="1900" max="{{ date('Y') }}">
                            @error('tahun')
